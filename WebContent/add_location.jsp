...
<title>Add Location || Online Inventory</title>
		...
		<div class="container">
		  ...
		  <div class="tabbable tabs-below">
			<ul class="nav nav-tabs">
              ...
              <li class="active"><a href="add_location.jsp">Add Location</a></li>
...
if(submit!=null)
{
	...
	String	sqlInsertItem="insert into location(location_name) values('"+name+"')";
